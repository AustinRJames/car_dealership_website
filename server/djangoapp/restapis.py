...
backend_url = os.getenv(
    "backend_url",
    default="https://arjames1128-3030.theiadockernext-0-labs-prod-theiak8s-4-tor01.proxy.cognitiveclass.ai/",
)

sentiment_analyzer_url = os.getenv(
    "sentiment_analyzer_url",
    default="https://sentianalyzer.1zypb7bu4bvl.us-south.codeengine.appdomain.cloud/",
